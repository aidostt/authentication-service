...
import (
	...
	server "authentication-service/internal/server/grpc_server"
...
func Run(configPath, envPath string) {
	...
	AuthHandlers := auth.NewAuthHandler(services, tokenManager)
	// gRPC Server
	srv := server.NewServer()
	AuthHandlers.RegisterServerAPI(srv.GrpcServer, services.Auth)
